...
;;; ported from EQ2 98.scr, decompiled by SCICompanion
(script# 800)
(include sci.sh)
(use Main)
;(use EcoI)
...
;;;						)
					...
					(KEY_ALT_g
						...
						(if (proc921_2 @temp6 4 {New Value?})
...
;;;						)
					...
					(KEY_ALT_t
						...
						(if
							(>
								(= gNewMyListFirst (proc255_1 {Which room number?}))
								0
							)
